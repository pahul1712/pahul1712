...
<details>
<summary><b>Other stuff I use</b></summary>

**NLP & GenAI:** Transformers/LLMs, RAG, FAISS/Chroma, LangChain, LangSmith  
**Data:** pandas, NumPy, Excel; SQL for analytics & joins; ETL-ish Python scripts  
**ML:** TensorFlow, PyTorch, scikit-learn, Keras; CV (CNNs), sequence models (RNN/LSTM/GRU)  
**Viz:** Matplotlib, Seaborn, Plotly, Tableau, Power BI  
**Cloud & Ops:** AWS basics, Streamlit/FASTAPI deploys, simple monitoring
</details>
